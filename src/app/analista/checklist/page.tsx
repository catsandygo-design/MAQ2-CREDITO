    ...
    <div className="cor-card" style={{ padding: '24px', background: '#0b1120', borderRadius: '12px', border: '1px solid #1e293b' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
        {[
          ...
          <div key={index} style={{ display: 'flex', alignItems: 'center', gap: '14px', padding: '14px', background: '#020617', borderRadius: '8px', border: '1px solid #334155' }}>
            <input type="checkbox" defaultChecked={index < 2} style={{ width: '18px', height: '18px', cursor: 'pointer', accentColor: '#3b82f6' }} />
...
// AQUI ESTÁ O SEGREDO QUE A VERCEL QUER: O EXPORT DEFAULT
export default function AnalystChecklistPage() {
  return (
    <DashboardShell title="Checklist de Auditoria" description="Validação de pastas físicas, conferência de dados e barramento.">
      <Suspense fallback={<div style={{ color: '#94a3b8', padding: '20px' }}>Carregando dados...</div>}>
        <ChecklistContent />
      </Suspense>
    </DashboardShell>
  );
