...
export const FINAL_MODULES: FinalModuleDefinition[] = [
  {
    ...
    implementationNotes: [
      'Unificar tarefas do dia, alertas do Foguetinho e atalhos por perfil.',
  ...
  {
    key: 'auxiliar-credito',
    label: 'Auxiliar Credito',
    path: '/auxiliar-credito',
    legacyPath: '/app/analista/acompanhamento-operacional',
    status: 'react-structure',
    owner: 'auxiliar_credito',
    purpose: 'Apoiar triagem documental, pendencias, importacao e organizacao da fila.',
    userValue: 'O usuario ve o que precisa conferir, corrigir ou encaminhar antes da analise.',
    implementationNotes: [
      'Criar fila auxiliar com documentos aguardando triagem e processos com dados incompletos.',
      'Permitir registro de observacoes e pendencias sem decisao final de credito.',
      'Manter importacao e conferencia basica como superficies de apoio operacional.',
    ],
  },
  {
    key: 'analista-credito',
    label: 'Analista Credito',
    path: '/analista',
    legacyPath: '/app/analista',
    status: 'react-ready',
    owner: 'analista_credito',
    purpose: 'Ser a mesa de decisao do credito, com fila, analise, documentos, repasse e Foguetinho.',
    userValue: 'Concentra decisao, bloqueios, documentos, SLA e proxima acao.',
    implementationNotes: [
  ...
  },
  {
    ...
    userValue: 'O usuario ve dados, documentos, bloqueios e Foguetinho no mesmo lugar.',
    implementationNotes: [
      'Criar contrato ProcessoFull antes de substituir o HTML.',
      'Adicionar painel lateral do Foguetinho com regra, motivo, campo e acao sugerida.',
  ...
  },
  {
    ...
    status: 'legacy-bridge',
    owner: 'corretor',
    purpose: 'Permitir pre-cadastro e acompanhamento restrito de clientes vinculados.',
    userValue: 'O corretor acompanha pendencias permitidas sem acessar a operacao interna.',
    implementationNotes: [
      'Separar portal do corretor da operacao de credito.',
      'Manter pre-cadastro, apresentacao e lista de clientes vinculados.',
      'Exibir status simplificado e pendencias solicitadas sem regras internas completas.',
    ],
  },
  {
    key: 'importacao',
  ...
  },
  {
    ...
    implementationNotes: [
      ...
      'Exibir bloqueios objetivos do Foguetinho antes do usuario tentar avancar.',
  ...
  },
  {
    ...
    implementationNotes: [
      ...
      'Proximas entregas: indicadores de acuracia do Foguetinho e retrabalho evitado.',
  ...
  },
  {
    ...
    status: 'react-structure',
    owner: 'diretoria',
    purpose: 'Dar visao executiva consolidada da carteira, gargalos, risco e performance.',
    userValue: 'A diretoria acompanha tendencia e risco sem operar a fila diaria.',
    implementationNotes: [
      'Criar dashboard consolidado com carteira, conversao, gargalos macro e risco operacional.',
      'Permitir abertura de detalhes somente em modo consulta, se aprovado.',
      'Separar indicadores executivos dos indicadores de produtividade do gestor.',
    ],
  },
  {
    key: 'foguetinho',
